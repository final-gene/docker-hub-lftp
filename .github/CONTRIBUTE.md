...
```bash
$ git clone git@github.com:finalgene/docker-hub-lftp.git
```

- Or via HTTPS:

```bash
$ git clone https://github.com/finalgene/docker-hub-lftp.git
```
...
2. Fork the repository (http://github.com/finalgene/docker-hub-lftp)
...
```bash
$ git remote add {username} git@github.com:{username}/docker-hub-lftp.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/docker-hub-lftp.git
